        ...
        <div className={styles.description}>
          <div className={styles.wrapper}>
            <GetInvolvedCard
              ...
              link="https://acmucsd.notion.site/outreach-workshops?v=256143915b12819d96a1000cadead966"
            />
            <GetInvolvedCard
              ...
              link="https://docs.google.com/forms/d/e/1FAIpQLSchgRVWVjKgPkjWFfZAvee42FB7Gaokr1D8eh-KAoNLKjrUyQ/viewform?usp=publish-editor"
            />
          </div>
        </div>
      </div>
